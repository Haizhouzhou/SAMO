...
def test_word_and_label_contracts_accept_synthetic_fixtures():
    ...
    assert "predictability_score" in prepared.columns


def test_example_config_dry_run_does_not_crash():
    root = Path(__file__).resolve().parents[1]
